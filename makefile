...
user-shell:
	...
	@$(LIN) -T $(SOURCE_FOLDER)/user/user-linker.ld -melf_i386 --oformat=binary \
		crt0.o user-shell.o string.o syscall.o ls.o find.o rm.o mv.o cp.o command.o -o $(OUTPUT_FOLDER)/shell
	@echo Linking object shell object files and generate flat binary...
	@$(LIN) -T $(SOURCE_FOLDER)/user/user-linker.ld -melf_i386 --oformat=elf32-i386 \
		crt0.o user-shell.o string.o syscall.o ls.o find.o rm.o mv.o cp.o command.o -o $(OUTPUT_FOLDER)/shell_elf
